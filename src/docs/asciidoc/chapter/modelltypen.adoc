...
Bei der Datenabgabe entspricht das Publikationsmodell am ehesten der klassischen Shapefile-Datenstruktur. Es wird kein zusätzliches Datenabgabemodell angestrebt.

**Offene Frage (2020-05-04):** Umgang mit Aufzähltypen. Sollen Aufzähltypen im Publikationsmodell verwendet werden? Wie wird aus einem Aufzähltyp-Wert ein "schöner" Text (mit Umlauten etc.).
