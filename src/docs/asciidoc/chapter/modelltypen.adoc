...
Bei der Datenabgabe entspricht das Publikationsmodell am ehesten der klassischen Shapefileabgabe. Es wird kein zusätzliches Datenabgabemodell abgestrebt.

**Offene Frage (2020-05-04):** Umgang mit Aufzähltypen. Sollen Aufzähltypen verwendet werden im Publikationsmodell? Wie wird aus einem Aufzähltyp-Wert ein "schöner" Text (mit Umlauten etc.).
