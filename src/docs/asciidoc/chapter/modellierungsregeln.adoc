...
#204:: Die Metaattribute `furtherInformation` (in der Regel der Link zur UML-Datei) und `technicalContact` (`mailto:agi@bd.so.chg`) sind im Header der Modelldatei (via UML-Editor) zu erfassen.
